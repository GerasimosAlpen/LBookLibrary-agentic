...
<div class="max-w-xl mx-auto space-y-6">
    ...
    <div>
        ...
        <p class="text-slate-400 mt-1 text-sm">Create a new category for organizing books.</p>
    </div>
    ...
    <form action="{{ route('categories.store') }}" method="POST"
        ...
        <div class="flex items-center gap-3 pt-2">
            ...
            <a href="{{ route('categories.index') }}" class="text-sm text-slate-400 hover:text-slate-200 transition px-4 py-2.5">Cancel</a>
        </div>
    </form>
</div>
@endsection
